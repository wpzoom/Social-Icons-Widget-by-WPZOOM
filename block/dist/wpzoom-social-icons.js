...
function Inspector({
  ...
  }), platforms.some(platform => platform.id === 'x' && platform.enabled) && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["__experimentalDivider"], null), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["TextControl"], {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('X/Twitter Username', 'social-icons-widget-by-wpzoom'),
    help: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('When sharing to X, this will be added as "via @username"', 'social-icons-widget-by-wpzoom'),
...
const getPlatformData = (id, xUsername = '') => {
  switch (id) {
    ...
    case 'x':
      let shareUrl = 'https://x.com/intent/tweet?url={url}&text={title}'; // Add the via parameter if username is provided
